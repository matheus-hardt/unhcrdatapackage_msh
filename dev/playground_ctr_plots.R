  ...
  if (nrow(Solution) == 0) {
    ...
    p <- ggplot(Solution, aes(x = Year, y = Value2)) +
      ...
      labs(
        ...
        x = "",
        y = "",
        caption = "Source: UNHCR.org/refugee-statistics.\n Resettlement â€“ in this context this is the country of arrival â€“ i.e. the country to which a refugee has been resettled \n Returns â€“ in this context this is the country of departure â€“ i.e. the country from which a refugee has voluntarily repatriated."
      )
  }
