...
If you want to add  new Charts in the Library please follow the steps below:  
 ...
 2. Check that the plot is not there already or check if it is not logged already within [existing issue](https://github.com/Edouard-Legoupil/unhcrviz/issues)

 3.  Create a [new issue](https://github.com/Edouard-Legoupil/unhcrviz/issues/new) in the package to discuss it 

 4. [Fork](https://github.com/Edouard-Legoupil/unhcrviz) the package

 5. Check the dev folder for the dedicated [devnotebook](https://github.com/Edouard-Legoupil/unhcrviz/blob/master/dev/flat_full.Rmd). , develop within the [fusen](https://thinkr-open.github.io/fusen/index.html) 
