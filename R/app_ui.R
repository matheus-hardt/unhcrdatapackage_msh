  ...
  tagList(
    ...
    shinydashboardPlus::dashboardPage(
      shinydashboardPlus::dashboardHeader(
        title = "Data Stories on Forced Displacement",
        #   titleWidth = "27%"
        titleWidth = 400 # ,
            ...
            tags$div(
              ...
              fluidRow(
                ...
                column(
                  2,
                  tags$i(
                    style = "font-size: 7rem;color:#0072BC;",
              ...
              column(
                ...
                tags$ol(
                  tags$li(
                    ...
                    actionLink(
                      inputId = "link_to_categories",
                      label = "categories"
                    ),
                    " of forcibly displaced and stateless people evolved over time?"
                  ),
                  tags$li(
                    "Which countries are the primary countries of ",
                    actionLink(
                      inputId = "link_to_origin",
                      label = "origin"
                    ),
                  ...
                  tags$li(
                    ...
                    actionLink(
                      inputId = "link_to_solutions",
                      label = "Solutions"
                    ),
                    " for forced displacement situations?"
                  ),
                  tags$li(
                    "What is the proportion of Forcibly Displaced People among the total ",
                    actionLink(
                      inputId = "link_to_migrants",
                      label = "migrant"
                    ),
                    " population?"
                  )
                ...
                hr(),
                p(
                  "The app is designed for Information Managers, Economist, Reporting officers, Data Journalist as well as anyone interested in Forced Displacement.
